...
module.exports = {
    ...
    AFNN: process.env.TAG_REPLY === undefined ? '918921661383@s.whatsapp.net' : process.env.TAG_REPLY,
    NBSK: process.env.ALL_NUMBER === undefined ? '918921661383?' : process.env.ALL_NUMBER,
    BLOCKCHAT: process.env.BLOCK_CHAT === undefined ? false : process.env.BLOCK_CHAT,
    ADDMSG: process.env.ADD_MESSAGE === undefined ? 'default' : process.env.ADD_MESSAGE,
    MUTEMSG: process.env.MUTE_MESSAGE === undefined ? 'default' : process.env.MUTE_MESSAGE,
    PLK: process.env.OWNER_NAME === undefined ? '🔰𝗔𝗟𝗙𝗬 𝗡 𝗦' : process.env.OWNER_NAME,
    ...
    created_by_alfy_n_s: process.env.ALL_IMG2 === undefined ? 'https://www.linkpicture.com/q/rgnk.jpg' : process.env.ALL_IMG2,
    ...
    SOURAVKL11: process.env.STICKER_DATA === undefined ? 'ᴀʟғʏ_ɴ_s|ʀᴀɢᷨᴀͦɴͭᴏʀᴋ' : process.env.STICKER_DATA,
    ANTI_FAKE: process.env.AUTO_FAKE === undefined ? 'alfy_n_s' : process.env.AUTO_FAKE,
